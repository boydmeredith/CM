...
h3<-ggplot(df_h1, aes(x=t0)) + chanceline+geom_vline(xintercept=0, linetype="dotted")+ theme_bw() 
h3 <- h3 + geom_ribbon(aes(ymin=mean_auc-sem_auc, ymax=mean_auc+sem_auc,alpha=1, fill=trte,color=trte)) + geom_line(aes(y=mean_auc,fill=trte,color=trte),linetype="dashed")
