function [subj] = create_balanced_xvalid_selectors_searchlight(subj,regsname,old_selname,varargin)
...
for i=1:nIterations
  ...
  gensel_bal = balance_active_selector(conds,gensel);

  % now recombine the newly balanced training and testing selectors
  new_sel = trnsel_bal*1 + tstsel_bal*2 + gensel_bal*3;
